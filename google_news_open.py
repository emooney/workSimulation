#!/usr/bin/env python3
"""Open news.google.com with Playwright.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Open https://news.google.com via Playwright."
    )
    parser.add_argument(
        "--headless",
        action="store_true",
        help="Run browser in headless mode (default is headed).",
    )
    parser.add_argument(
        "--wait-seconds",
        type=float,
...
def main() -> int:
    ...
    try:
        ...
        with sync_playwright() as playwright:
            ...
            print("Opened https://news.google.com using Playwright.")
            browser.close()
